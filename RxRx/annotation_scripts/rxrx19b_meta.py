...
disease_dict = {
    'healthy': 'healthy cytokine cocktail',
    'storm-severe': 'severe cytokine storm cocktail',
    '': 'no cytokines',
}
...
for i, p in enumerate(arrowpaths):
    ...
    combined_pandas['experimental_technique'] = ' High-Dimensional Cellular Assay for COVID-19 Cytokine Storm'
